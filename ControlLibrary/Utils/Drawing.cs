...
namespace ControlLibrary.Utils
{
	public static class Drawing
	{
		...
		public static void DrawButtonOk(Graphics graphics, Color foreColor, Color backColor, Rectangle rect)
		{
			...
			path.Dispose();
			graphics.DrawEllipse(new Pen(foreColor), rect);
		}

		public static void DrawButtonCancel(Graphics graphics, Color foreColor, Color backColor, Rectangle rect)
		{
			...
			graphics.DrawLine(new Pen(foreColor), points[0], points[2]);
			graphics.DrawLine(new Pen(foreColor), points[3], points[1]);
