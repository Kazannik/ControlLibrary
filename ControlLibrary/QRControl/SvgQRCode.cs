using Controls.QRCoder.Extensions;
using System;
using System.Collections;
using System.Drawing;
using System.Text;

namespace Controls.QRCoder
{
	public class SvgQRCode : AbstractQRCode, IDisposable
	{
		...
		{
			var viewBox = new Size(pixelsPerModule * QrCodeData.ModuleMatrix.Count, pixelsPerModule * this.QrCodeData.ModuleMatrix.Count);
